...
export const verify = (token: string) => token ? (jws.verify as ((token: string, secret: string, options?: { algorithms?: string[] }) => boolean))(token, publicKey, { algorithms: ['RS256'] }) : false
